	...
	public static void main(String[] args) {
		...
		for(int i=1; i<=10; i++) {
			...
			if(num == 0) {	
				...
				System.out.println("Número impar empilhando na pilha ímpar. " + num);
				impar.empilha(num);
		...
		System.out.println("Pilha ímpar: " + impar);
		...
		while(!impar.estaVazia()) {
			System.out.println("Desempilhando pilha par: " + impar.desempilha());
		}
